...
public class Main {
			...
			if(input == 1){
				...
				while (a > 0 && a < 3){
					...
					if(a == 1){
						if (AdminUILogin()) { 
							int r = 1;
							while(r > 0 && r < 12){ //r should be within 1 to 10
								r = AdminUIMain();
								switch(r){			//12 to logout
									case 1:
										//Add Movie
	...
	static void Init() {
		...
		MovieSchedule.add(new MovieSchedule(Movie.get(2).getMovieTitle(), 1 ,"GV", "202212121500"));
