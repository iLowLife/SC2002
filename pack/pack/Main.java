				...
				while(r > 0 && r < 4){ //r should be within 1 to 4
					...
					case 2:
						...
						if(MovieGoerUILogin()){//On Login Success, move to Booking UI
							...
							int x = 1;
							while(x > 0 && x < 6){ //r should be within 1 to 6
								x = MovieGoerUIMain();
...
*/
		Movie.add(new Movie("Movie 1", "Preview", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		Movie.add(new Movie("Movie 2", "Preview", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		Movie.add(new Movie("Movie 3", "Coming Soon", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		Movie.add(new Movie("Movie 4", "Coming Soon", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		Movie.add(new Movie("Movie 5", "Now Showing", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		Movie.add(new Movie("Movie 6", "Now Showing", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		Movie.add(new Movie("Movie 7", "Now Showing", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		Movie.add(new Movie("Movie 8", "End of Showing", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		Movie.add(new Movie("Movie 9", "End of Showing", "Something Short", "1", new String[] { "1", "2", "3", "4", "5" }));
		...
		MovieSchedule.add(new MovieSchedule(Movie.get(0).getMovieTitle(), 0 ,"SW0", "202212121900"));
		MovieSchedule.add(new MovieSchedule(Movie.get(1).getMovieTitle(), 2 ,"SW1", "202212121700"));
		MovieSchedule.add(new MovieSchedule(Movie.get(2).getMovieTitle(), 1 ,"GV0", "202212121500"));
		MovieSchedule.add(new MovieSchedule(Movie.get(3).getMovieTitle(), 2 ,"GV1", "202301011300")); //Holiday
		MovieSchedule.add(new MovieSchedule(Movie.get(4).getMovieTitle(), 2 ,"GV2", "202211051100")); //Weekend

		//Create Holiday Objects
		HolidayDate.add(new Holiday("1/1/2023"));
		HolidayDate.add(new Holiday("22/1/2023"));
		HolidayDate.add(new Holiday("7/4/2023"));
		HolidayDate.add(new Holiday("22/1/2023"));
		HolidayDate.add(new Holiday("1/5/2023"));
		HolidayDate.add(new Holiday("2/6/2023"));
		HolidayDate.add(new Holiday("29/6/2023"));
		HolidayDate.add(new Holiday("9/8/2023"));
		HolidayDate.add(new Holiday("12/11/2023"));
	}
